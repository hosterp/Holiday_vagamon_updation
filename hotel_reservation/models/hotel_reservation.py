...
class HotelReservation(models.Model):
    ...
    reservation_no = fields.Char('Reservation No', size=64)
    ...
    children = fields.Integer('Children with Bed', size=64, readonly=True,
                              states={'draft': [('readonly', False)]},
    ...
    def create(self, vals):
        ...
        print "wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww",vals
...
class QuickRoomReservation(models.TransientModel):
    ...
    def default_get(self, fields):
        ...
        @return: A dictionary which of fields with values.
        """
        # res = super(HotelReservation, self).default_get(fields, context=context)
    ...
    def room_reserve(self):
        ...
        for res in self:
            ...
            checkin = datetime.datetime.strptime(res.check_in, date_format).strftime("%Y-%m-%d")
            checkout = datetime.datetime.strptime(res.check_out, date_format).strftime("%Y-%m-%d")
