...
class Employee(models.TransientModel):
	...
	def action_employee_open_window(self):
			...
			return{
				 ...
				 'report_name' : 'hiworth_attendance.report_employee_details_template',
				 'datas': datas,
...
class JoiningEmployees(models.Model):
		...
		def action_open_window(self):
			 ...
			 return{
					 'name' : 'Site Joinees',
					 'type' : 'ir.actions.report.xml',
					 'report_name' : 'hiworth_attendance.report_employee_site_joinees_template',
					 'datas': datas,
					 'report_type': 'qweb-pdf'
			 }
...
class ResigningEmployees(models.Model):
		...
		def action_open_window(self):
			 ...
			 return{
					 ...
					 'type' : 'ir.actions.report.xml',
					 'report_name' : 'hiworth_attendance.report_employee_site_resign_template',
					 'datas': datas,
					 'report_type': 'qweb-pdf'
			 }
...
class EmployeelnsuranceReport(models.Model):
		...
		def action_employee_insurance_open_window(self):
			...
			return{
				 'name' : 'Employee Report',
				 'type' : 'ir.actions.report.xml',
				 'report_name' : 'hiworth_attendance.report_employee_insurance_details_template',
				 'datas': datas,
				 'report_type': 'qweb-pdf'
			}
...
class EmployeelnsuranceRenewalReport(models.Model):
		...
		def action_employee_insurance_open_window(self):
			...
			return{
				 'name' : 'Employee Report',
				 'type' : 'ir.actions.report.xml',
				 'report_name' : 'hiworth_attendance.report_employee_insurance_renewal_template',
				 'datas': datas,
				 'report_type': 'qweb-pdf'
			}
...
class PF_ESIReport(models.Model):
		...
		def action_employee_pf_esi_open_window(self):
			...
			return{
				 'name' : 'Employee Report',
				 'type' : 'ir.actions.report.xml',
				 'report_name' : 'hiworth_attendance.report_employee_pf_esi_template',
				 'datas': datas,
				 'report_type': 'qweb-pdf'
			}
